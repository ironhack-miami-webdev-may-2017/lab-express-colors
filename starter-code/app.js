...
// Beige-Colors
  app.get('/beige', (req, res, nxt) => {
    res.render('beige-colors.ejs', {
      colorsForView: colors
    });
});
// Blue-Colors
  app.get('/blue', (req, res, nxt) => {
    res.render('blue-colors.ejs', {
      colorsForView: colors
    });
});
// brown-Colors
  app.get('/brown', (req, res, nxt) => {
    res.render('brown-colors.ejs', {
      colorsForView: colors
    });
});
// green-Colors
  app.get('/green', (req, res, nxt) => {
    res.render('green-colors.ejs', {
      colorsForView: colors
    });
});
// greyscale-Colors
  app.get('/greyscale', (req, res, nxt) => {
    res.render('greyscale-colors.ejs', {
      colorsForView: colors
    });
});
// orange-Colors
  app.get('/orange', (req, res, nxt) => {
    res.render('orange-colors.ejs', {
      colorsForView: colors
    });
});
// pink-Colors
  app.get('/pink', (req, res, nxt) => {
    res.render('pink-colors.ejs', {
      colorsForView: colors
    });
});
// purple-Colors
  app.get('/purple', (req, res, nxt) => {
    res.render('purple-colors.ejs', {
      colorsForView: colors
    });
});
// red-Colors
  app.get('/red', (req, res, nxt) => {
    res.render('red-colors.ejs', {
      colorsForView: colors
    });
});
// yellow-Colors
  app.get('/yellow', (req, res, nxt) => {
