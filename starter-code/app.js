...
app.get("/colors",(req,res,next) => {
  res.render("colors.ejs",{colors : colors});
});

app.get("/gray",(req,res,next) => {
  res.render("grayCat.ejs",{colors : colors});
});

app.get("/pink",(req,res,next) => {
  res.render("pinkCat.ejs",{colors : colors});
});

app.get("/beige",(req,res,next) => {
  res.render("beigeCat.ejs",{colors : colors});
});

app.get("/random",(req,res,next)=> {
  let randColor = colors[ Math.floor(Math.random()* colors.length) ];
  res.render("randomColor.ejs",{randColor : randColor});
});
