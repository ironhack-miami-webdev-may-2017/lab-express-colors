...
app.locals.myTitle = "Express Colors";

app.get('/', (req,res,next)=> {


  res.render(
    'home.ejs',  // 1st arg --> name of view file
...
app.get('/grayscale',(req,res, next) => {
  res.render('grayscale.ejs',{
    colorsList: colors,
    myTitle: "Grayscale - Express Colors"
...
app.get('/random',(req,res, next) => {
  ...
  res.render('random.ejs',{
     ...
     pickedCategory: pickedColor.category,
     colorsList: colors,
     myTitle: "Random Color - Express Colors"
  });
});
